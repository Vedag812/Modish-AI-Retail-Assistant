                    ...
                    {items.map((item) => {
                        ...
                        <Card key={item.id}>
                            <CardContent className="flex items-center p-4">
                                <div className="relative h-28 w-24 flex-shrink-0 overflow-hidden rounded-md bg-muted">
                                {productImage && (
                                    <Image src={productImage} alt={item.name} fill className="object-contain p-1" />
                                )}
                                </div>
